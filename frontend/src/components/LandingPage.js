...
<div style={{width: '100%', height: '100%', position: 'relative', background: 'black'}}>
    ...
    <div style={{paddingTop: 34, paddingBottom: 42, paddingLeft: 65, paddingRight: 113, left: 0, top: 1832, position: 'absolute', justifyContent: 'center', alignItems: 'center', display: 'inline-flex', background:'black'}}>
