    ...
    async function login(e) {
        ...
        UserService.login(user)
            .then((response) => {
                ...
                //navigate("../home", { replace: true }); // Navigate based on role or another condition if needed
            })
            .catch((e) => {
                console.log(e);
    ...
    return (
        <div style={{ width: '100%', height: '100%', position: 'relative', background: 'black' }}>
            ...
            <form onSubmit={login} style={{ width: 795, height: 658, left: 326, top: 183, position: 'absolute', background: 'white', borderRadius: 24, overflow: 'hidden' }}>
                <div style={{ width: 32, height: 32, left: 731, top: 32, position: 'absolute' }}>
