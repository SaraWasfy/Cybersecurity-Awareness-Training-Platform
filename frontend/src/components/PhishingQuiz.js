...
<div style={{height: 81, left: 40, top: 16, position: 'absolute'}}>
    ...
    <div style={{width: 1440, height: 13954, position: 'relative', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
        <div style={{width: 1440, height: 558.50, position: 'relative'}}>
            ...
            {showResponse1 &&response1 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse1 &&response1 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 532.50, position: 'relative'}}>
            ...
            {showResponse2 &&response2 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse2 &&response2 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}            <div style={{width: 1302, height: 0.50, left: 71, top: 532, position: 'absolute', background: 'white'}}></div>
        ...
        <div style={{width: 1440, height: 504.50, position: 'relative'}}>
            ...
            {showResponse3 &&response3 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse3 &&response3 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 570.50, position: 'relative'}}>
            ...
            {showResponse4 &&response4 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse4 &&response4 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 570.50, position: 'relative'}}>
            ...
            <div style={{width: 1302, height: 0.50, left: 71, top: 570, position: 'absolute', background: 'white'}}></div>
            {showResponse5 &&response5 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse5 &&response5 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 560.50, position: 'relative'}}>
            ...
            {showResponse6 &&response6 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse6 &&response6 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 570.50, position: 'relative'}}>
            ...
            <div style={{width: 1302, height: 0.50, left: 71, top: 570, position: 'absolute', background: 'white'}}></div>
            {showResponse7 &&response7 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse7 &&response7 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 570.50, position: 'relative'}}>
            ...
            <div style={{width: 1302, height: 0.50, left: 71, top: 570, position: 'absolute', background: 'white'}}></div>
            {showResponse8 &&response8 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse8 &&response8 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 570.50, position: 'relative'}}>
            ...
            <div style={{width: 1302, height: 0.50, left: 71, top: 570, position: 'absolute', background: 'white'}}></div>
            {showResponse9 &&response9 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse9 &&response9 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 603.50, position: 'relative'}}>
            ...
            {showResponse10 &&response10 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse10 &&response10 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 603.50, position: 'relative'}}>
            ...
            {showResponse11 &&response11 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse11 &&response11 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 520.50, position: 'relative'}}>
            ...
            {showResponse12 &&response12 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse12 &&response12 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 647.50, position: 'relative'}}>
            ...
            {showResponse13 &&response13 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse13 &&response13 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 816.50, position: 'relative'}}>
            ...
            {showResponse14 &&response14 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse14 &&response14 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 613.50, position: 'relative'}}>
            ...
            {showResponse16 &&response16 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse16 &&response16 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 496.50, position: 'relative'}}>
            ...
            {showResponse17 &&response17 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse17 &&response17 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 552.50, position: 'relative'}}>
            ...
            {showResponse18 &&response18 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse18 &&response18 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 552.50, position: 'relative'}}>
            ...
            <div style={{width: 1302, height: 0.50, left: 69, top: 552, position: 'absolute', background: 'white'}}></div>
            {showResponse19 &&response19 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse19 &&response19 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 389.50, position: 'relative'}}>
            ...
            {showResponse20 &&response20 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse20 &&response20 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        <div style={{width: 1440, height: 757.50, position: 'relative'}}>
            ...
            {showResponse21 &&response21 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse21 &&response21 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        ...
        {showResponse22 &&<div style={{width: 1440, height: 120, left: 0, top: 479, position: 'absolute', textAlign: 'center', color: 'white', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>While some phishers phish for specific information such as usernames and passwords, credit card details, social security numbers, others might make use of any personal information.<br/>So, the correct answer is all of the above</div>}
            ...
            {showResponse22 &&response22 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse22 &&response22 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        </div>
        <div style={{width: 1440, height: 594.50, position: 'relative'}}>
            ...
            {showResponse23 &&response23 === 'correct' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#03fc2c', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>+10 Points</div>}
            {showResponse23 &&response23 === 'wrong' && <div style={{width: 1440, height: 100, left: 0, top: 210, position: 'absolute', textAlign: 'center', color: '#DB1B24', fontSize: 24, fontFamily: 'Mulish', fontWeight: '700', wordWrap: 'break-word'}}>0 Points</div>}
        </div>
